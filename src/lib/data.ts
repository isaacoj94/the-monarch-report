...
// Current values (updated 2026-09-25)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1856, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1368.6, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1856, unit: '₩', trend: 'rising', changePercent: 7,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1856, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1368.6, unit: '₩', trend: 'falling', changePercent: -2.6,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1368.6, 0.03),
  },
  householdDebt: {
