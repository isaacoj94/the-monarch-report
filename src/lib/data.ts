...
// Current values (updated 2026-07-01)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1934, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1550.89, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1934, unit: '₩', trend: 'rising', changePercent: 11.5,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1934, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1550.89, unit: '₩', trend: 'rising', changePercent: 10.4,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1550.89, 0.03),
  },
  householdDebt: {
