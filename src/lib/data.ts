...
// Current values (updated 2026-09-10)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1336.2, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1336.2, unit: '₩', trend: 'falling', changePercent: -4.9,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1336.2, 0.03),
  },
  householdDebt: {
