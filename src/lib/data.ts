...
// Current values (updated 2026-08-01)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1867, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1443.61, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1867, unit: '₩', trend: 'rising', changePercent: 7.6,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1867, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1443.61, unit: '₩', trend: 'rising', changePercent: 2.7,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1443.61, 0.03),
  },
  householdDebt: {
  ...
  youthUnemployment: {
    id: 'youthUnemployment', currentValue: 7.11, unit: '%', trend: 'falling', changePercent: -7.7,
    presidencyStartValue: 7.7, history: generateMonthlyData(PRESIDENCY_START, 7.7, 7.11, 0.08),
  },
  interestRate: {
