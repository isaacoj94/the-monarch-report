...
// Current values (updated 2026-09-19)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1388.1, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1388.1, unit: '₩', trend: 'falling', changePercent: -1.2,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1388.1, 0.03),
  },
  householdDebt: {
