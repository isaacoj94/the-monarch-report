...
// Current values (updated 2026-09-16)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1359.15, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1359.15, unit: '₩', trend: 'falling', changePercent: -3.3,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1359.15, 0.03),
  },
  householdDebt: {
