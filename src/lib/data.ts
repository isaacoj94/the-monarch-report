...
// Current values (updated 2026-06-07)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1540.93, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1540.93, unit: '₩', trend: 'rising', changePercent: 9.7,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1540.93, 0.03),
  },
  householdDebt: {
