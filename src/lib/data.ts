...
// Current values (updated 2026-04-28)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1471.22, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1471.22, unit: '₩', trend: 'rising', changePercent: 4.7,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1471.22, 0.03),
  },
  householdDebt: {
