...
// Current values (updated 2026-05-22)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1508.74, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1508.74, unit: '₩', trend: 'rising', changePercent: 7.4,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1508.74, 0.03),
  },
  householdDebt: {
