...
// Current values (updated 2026-05-25)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1517.55, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1517.55, unit: '₩', trend: 'rising', changePercent: 8,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1517.55, 0.03),
  },
  householdDebt: {
