...
// Current values (updated 2026-06-19)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 2009, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1538.89, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 2009, unit: '₩', trend: 'rising', changePercent: 15.8,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 2009, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1538.89, unit: '₩', trend: 'rising', changePercent: 9.5,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1538.89, 0.03),
  },
  householdDebt: {
