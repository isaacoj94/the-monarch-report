...
export const LAST_UPDATED_PROSE = (() => {
  const d = new Date(LAST_UPDATED);
  return d.toLocaleString('en-US', { month: 'short', year: 'numeric' });
})();

// Current values (updated 2026-06-25)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 2007, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1546.43, householdDebt: 105.8, nationalDebt: 51.6,
  inflation: 2.0, youthUnemployment: 7.31, interestRate: 2.50,
  kospi: 8930.3,
};
...
function generateMonthlyData(
  ...
  const end = new Date(LAST_UPDATED);
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 2007, unit: '₩', trend: 'rising', changePercent: 15.7,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 2007, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1546.43, unit: '₩', trend: 'rising', changePercent: 10.1,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1546.43, 0.03),
  },
  householdDebt: {
  ...
  youthUnemployment: {
    id: 'youthUnemployment', currentValue: 7.31, unit: '%', trend: 'falling', changePercent: -5.1,
    presidencyStartValue: 7.7, history: generateMonthlyData(PRESIDENCY_START, 7.7, 7.31, 0.08),
  },
  interestRate: {
