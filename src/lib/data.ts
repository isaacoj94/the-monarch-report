...
// Current values (updated 2026-09-22)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1858, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1372.18, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1858, unit: '₩', trend: 'rising', changePercent: 7.1,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1858, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1372.18, unit: '₩', trend: 'falling', changePercent: -2.3,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1372.18, 0.03),
  },
  householdDebt: {
