...
// Current values (updated 2026-03-22)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1500.8, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1500.8, unit: '₩', trend: 'rising', changePercent: 6.8,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1500.8, 0.03),
  },
  householdDebt: {
