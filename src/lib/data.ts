...
// Current values (updated 2026-08-13)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1417.13, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1417.13, unit: '₩', trend: 'stable', changePercent: 0.9,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1417.13, 0.03),
  },
  householdDebt: {
