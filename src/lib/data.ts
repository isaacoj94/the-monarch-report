...
// Current values (updated 2026-07-31)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1868, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1433.7, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1868, unit: '₩', trend: 'rising', changePercent: 7.7,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1868, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1433.7, unit: '₩', trend: 'rising', changePercent: 2,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1433.7, 0.03),
  },
  householdDebt: {
