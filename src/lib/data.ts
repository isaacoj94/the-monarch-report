...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1865, unit: '₩', trend: 'rising', changePercent: 7.5,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1865, 0.04),
  },
  ricePrice: {
