...
// Current values (updated 2026-08-25)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1384.26, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1861, unit: '₩', trend: 'rising', changePercent: 7.3,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1861, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1384.26, unit: '₩', trend: 'falling', changePercent: -1.5,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1384.26, 0.03),
  },
  householdDebt: {
