...
// Current values (updated 2026-07-07)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1892, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1531.07, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1892, unit: '₩', trend: 'rising', changePercent: 9,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1892, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1531.07, unit: '₩', trend: 'rising', changePercent: 9,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1531.07, 0.03),
  },
  householdDebt: {
