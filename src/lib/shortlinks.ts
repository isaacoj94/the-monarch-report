...
export const SHORTLINKS: Record<string, Shortlink> = {
  ...
  doc:        { base: '/films',                                                      campaign: 'youre-next-doc-2026',      medium: 'story' },
  trailer:    { base: '/films',                                                      campaign: 'youre-next-doc-2026',      medium: 'story' },
  films:      { base: '/films',                                                      campaign: 'youre-next-doc-2026',      medium: 'story' },
