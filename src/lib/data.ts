...
// Current values (updated 2026-09-04)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1859, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1357.29, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1859, unit: '₩', trend: 'rising', changePercent: 7.1,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1859, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1357.29, unit: '₩', trend: 'falling', changePercent: -3.4,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1357.29, 0.03),
  },
  householdDebt: {
