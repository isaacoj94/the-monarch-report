...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1374.55, unit: '₩', trend: 'falling', changePercent: -2.2,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1374.55, 0.03),
  },
  householdDebt: {
