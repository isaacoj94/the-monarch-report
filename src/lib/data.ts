...
// Current values (updated 2026-07-04)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1906, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1531.23, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1906, unit: '₩', trend: 'rising', changePercent: 9.9,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1906, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1531.23, unit: '₩', trend: 'rising', changePercent: 9,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1531.23, 0.03),
  },
  householdDebt: {
