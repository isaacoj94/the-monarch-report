...
// Current values (updated 2026-06-22)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 2008, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1532.31, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 2008, unit: '₩', trend: 'rising', changePercent: 15.7,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 2008, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1532.31, unit: '₩', trend: 'rising', changePercent: 9.1,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1532.31, 0.03),
  },
  householdDebt: {
