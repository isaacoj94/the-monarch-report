...
// Current values (updated 2026-05-07)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1448.1, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1448.1, unit: '₩', trend: 'rising', changePercent: 3.1,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1448.1, 0.03),
  },
  householdDebt: {
