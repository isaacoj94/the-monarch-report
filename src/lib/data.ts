...
// Current values (updated 2026-03-19)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1503.55, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1503.55, unit: '₩', trend: 'rising', changePercent: 7,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1503.55, 0.03),
  },
  householdDebt: {
