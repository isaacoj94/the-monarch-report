...
// Current values (updated 2026-09-13)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1342.79, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1342.79, unit: '₩', trend: 'falling', changePercent: -4.4,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1342.79, 0.03),
  },
  householdDebt: {
