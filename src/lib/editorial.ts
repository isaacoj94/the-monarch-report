...
export const koreaTimeline: KoreaTimelineEntry[] = [
  ...
  // === CURRENT EDITORIAL DESK ===
  {
    ...
    descriptionKo: '8월 1일 수사 책임 이관이 방첩 사건과 기관 간 공조, 책임 소재에 미칠 영향을 짚었다.',
    descriptionJa: '8月1日の捜査権限移管が、防諜事件や省庁間連携、責任の所在に及ぼす影響を検証した。',
    category: 'foreign-policy',
  ...
  },
  {
    ...
    descriptionKo: '경찰 수사의 비중을 키운 법 개편을 분석하고, 부실·분쟁 수사에 대응할 구제 절차가 무엇인지 확인했다.',
    descriptionJa: '警察捜査の比重を高める制度改編を分析し、不十分な捜査や争いが生じた場合に残る救済手段を確認した。',
    category: 'legislation',
    source: 'The Monarch Report on X',
  ...
  },
  {
    ...
    descriptionKo: '지원금의 과세 방식이 교회·선교사에게 미칠 영향과 종교활동·과세 대상 보수의 경계를 분석했다.',
    descriptionJa: '支援金の税務上の扱いが教会や宣教師に及ぼす影響と、宗教活動と課税対象報酬の境界を分析した。',
  ...
  },
  {
    ...
    descriptionKo: '변호인단은 사건 기록에 상충하는 진술이 있다고 주장했다. 재판이 진행 중인 만큼 변호인 측 주장과 확인된 사실을 구분했다.',
    descriptionJa: '弁護側は、事件記録に食い違う供述があると主張した。審理中のため、弁護側の主張と確認済みの事実を分けて伝える。',
    category: 'court-case',
    source: 'The Monarch Report on X',
  ...
  },
  {
    ...
    titleKo: '다시 고개 든 공산주의 담론…신앙·가정에 미칠 영향',
    titleJa: '共産主義への関心が再燃、信仰と家族への影響は',
    ...
    descriptionKo: '공산주의가 내세운 약속과 역사적 기록을 비교하고, 신앙·가정·재산권·언론 자유가 사회의 안전장치로 작동하는 이유를 분석했다.',
    descriptionJa: '共産主義が掲げた理念と歴史的記録を比較し、信仰、家族、財産権、報道の自由が社会の歯止めとなる理由を分析した。',
    category: 'media',
    source: 'The Monarch Report on X',
