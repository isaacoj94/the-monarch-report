...
// Current values (updated 2026-05-10)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1466.78, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1466.78, unit: '₩', trend: 'rising', changePercent: 4.4,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1466.78, 0.03),
  },
  householdDebt: {
