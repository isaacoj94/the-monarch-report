...
// Current values (updated 2026-08-04)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1866, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1427.05, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1866, unit: '₩', trend: 'rising', changePercent: 7.6,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1866, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1427.05, unit: '₩', trend: 'rising', changePercent: 1.6,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1427.05, 0.03),
  },
  householdDebt: {
