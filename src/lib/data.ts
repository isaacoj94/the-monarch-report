...
// Current values (updated 2026-06-28)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1988, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1536.47, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1988, unit: '₩', trend: 'rising', changePercent: 14.6,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1988, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1536.47, unit: '₩', trend: 'rising', changePercent: 9.4,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1536.47, 0.03),
  },
  householdDebt: {
