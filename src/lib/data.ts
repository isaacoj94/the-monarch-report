...
// Current values (updated 2026-09-07)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1350.35, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1350.35, unit: '₩', trend: 'falling', changePercent: -3.9,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1350.35, 0.03),
  },
  householdDebt: {
