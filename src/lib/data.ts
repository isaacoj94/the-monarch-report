...
// Current values (updated 2026-03-25)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1498.86, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1498.86, unit: '₩', trend: 'rising', changePercent: 6.7,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1498.86, 0.03),
  },
  householdDebt: {
