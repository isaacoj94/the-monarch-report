...
// Current values (updated 2026-09-01)
export const currentSnapshot: Record<string, number> = {
  gasPrice: 1860, ricePrice: 33000, eggsPrice: 7000, porkBellyPrice: 2637,
  ...
  usdKrw: 1368.03, householdDebt: 105.8, nationalDebt: 51.6,
...
export const walletMetrics: Record<string, Metric> = {
  gasPrice: {
    id: 'gasPrice', currentValue: 1860, unit: '₩', trend: 'rising', changePercent: 7.2,
    presidencyStartValue: 1735, history: generateMonthlyData(PRESIDENCY_START, 1735, 1860, 0.04),
  },
  ricePrice: {
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1368.03, unit: '₩', trend: 'falling', changePercent: -2.6,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1368.03, 0.03),
  },
  householdDebt: {
