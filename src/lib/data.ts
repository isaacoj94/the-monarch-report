...
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1477, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1477, unit: '₩', trend: 'rising', changePercent: 5.1,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1477, 0.03),
  },
  householdDebt: {
