...
// Current values (updated 2026-03-28)
export const currentSnapshot: Record<string, number> = {
  ...
  usdKrw: 1511.5, householdDebt: 105.8, nationalDebt: 51.6,
...
export const macroMetrics: Record<string, Metric> = {
  usdKrw: {
    id: 'usdKrw', currentValue: 1511.5, unit: '₩', trend: 'rising', changePercent: 7.6,
    presidencyStartValue: 1405, history: generateMonthlyData(PRESIDENCY_START, 1405, 1511.5, 0.03),
  },
  householdDebt: {
